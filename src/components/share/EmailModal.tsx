...
import ContactUsForm from"@/src/app/api/emails/ContactUsForm";
    ...
    <div className="px-5 py-3
     mb-12 grid place-content-center bg-amber-600-50">
      <button
        ...
        className="mb-12 text-4xl bg-gradient-to-b from-amber-500 to-yellow-600 text-white font-medium px-4 py-2 r hover:opacity-90 shadow-sm hovr:shadow-lg shadow-black transition-opacity"
      >
    ...
    <AnimatePresence>
      ...
      {/*<FiAlertCircle className="text-white/ rotate-12 text-[250px] absolute z-0 -top-24 -left-24" />*/}
            <div className="relative z-10">
              ...
              <h3 className="mt-2 py-2 text-4xl text-slate-500 font-bold text-center mb-5">
